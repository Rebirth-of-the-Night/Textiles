...
public class RenderEntityBasket extends Render<EntityBasket> {
    private final RenderItem itemRenderer;
    private final Random random = new Random();

    public RenderEntityBasket(RenderManager renderManagerIn, RenderItem p_i46167_2_)
    {
    ...
    private int transformModelCount(EntityBasket itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_)
    {
